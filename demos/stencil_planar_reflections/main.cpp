...
GeometryPtr createCube(){
	...
	std::vector<Vertex> vertices({
		// Bottom Face (Red)
        {Vector3f({-1,-1, 1}), Vector3f({1,0,0})}, // index: 0
		{Vector3f({-1,-1,-1}), Vector3f({1,0,0})}, // index: 1
		{Vector3f({ 1,-1,-1}), Vector3f({1,0,0})}, // index: 2
		{Vector3f({ 1,-1, 1}), Vector3f({1,0,0})}, // index: 3
		
		// Front Face (Blue)
		{Vector3f({-1,-1, 1}), Vector3f({0,0,1})}, // index: 4
		{Vector3f({ 1,-1, 1}), Vector3f({0,0,1})}, // index: 5
		{Vector3f({ 1, 1, 1}), Vector3f({0,0,1})}, // index: 6
		{Vector3f({-1, 1, 1}), Vector3f({0,0,1})}, // index: 7
		
		// Right Face (Green)
		{Vector3f({ 1,-1, 1}), Vector3f({0,1,0})}, // index: 8
		{Vector3f({ 1,-1,-1}), Vector3f({0,1,0})}, // index: 9
		{Vector3f({ 1, 1,-1}), Vector3f({0,1,0})}, // index: 10
		{Vector3f({ 1, 1, 1}), Vector3f({0,1,0})}, // index: 11
		
		// Back Face (Yellow)
		{Vector3f({ 1,-1,-1}), Vector3f({1,1,0})}, // index: 12
		{Vector3f({-1,-1,-1}), Vector3f({1,1,0})}, // index: 13
		{Vector3f({-1, 1,-1}), Vector3f({1,1,0})}, // index: 14
		{Vector3f({ 1, 1,-1}), Vector3f({1,1,0})}, // index: 15
		
		// Left Face (Purple)
		{Vector3f({-1,-1, 1}), Vector3f({1,0,1})}, // index: 16
		{Vector3f({-1, 1, 1}), Vector3f({1,0,1})}, // index: 17
		{Vector3f({-1, 1,-1}), Vector3f({1,0,1})}, // index: 18
		{Vector3f({-1,-1,-1}), Vector3f({1,0,1})}, // index: 19
		
		// Top Face (Blueish green)
		{Vector3f({-1, 1, 1}), Vector3f({0,1,1})}, // index: 20
		{Vector3f({ 1, 1, 1}), Vector3f({0,1,1})}, // index: 21
		{Vector3f({ 1, 1,-1}), Vector3f({0,1,1})}, // index: 22
		{Vector3f({-1, 1,-1}), Vector3f({0,1,1})}, // index: 23
	});
...
GeometryPtr createFloor(const float &size){
	std::vector<Vertex> vertices({
        {Vector3f({ size, 0, size}), Vector3f({0.1,0.1,0.1})},
		{Vector3f({ size, 0,-size}), Vector3f({0.1,0.1,0.1})},
		{Vector3f({-size, 0,-size}), Vector3f({0.1,0.1,0.1})},
		{Vector3f({-size, 0, size}), Vector3f({0.1,0.1,0.1})}
	});
